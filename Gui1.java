...
public class Gui1 {
    ...
    public static void login() {
        ...
        while (true) {
            System.out.println("Welcome to Climate Change Application!");
    ...
    private static class adminTask {
        ...
        private static final String[][] TASKS_DATA = {
                {"Policies", "SDG 13 Policies to combat Climate Change are: \n" +
                        "1. Food security, nutrition and livelihoods will be improved by adopting climate-friendly agriculture system.\n" +
                        "2. Sustainable environmental services will be ensured by developing climate resilient ecosystem. \n" +
                        "3. Energy security will be ensured by promoting multiple use of water resources and production of low carbon energy.\n" +
                        "4. Climate-friendly villages and cities will be built by developing safe, sustainable and resilient habitats and infrastructures\n" +
                        "5. The concept of climate resilient economic development will be adopted by developing reliable, sustainable and low carbon technology industry, transport and physical infrastructure. \n" +
                        "6. Important natural, cultural and social heritages will be conserved and developed by making tourism sector climate-friendly.\n"},
                {"Strategies", "Please chronologically enter one numeric value of the listed Topics for Clarification of Strategies: \n" +
                        "1. Agriculture and Food Security (1) \n" +
                        "2. Forest, Biodiversity and Watershed Conservation (2) \n" +
                        "3. Water Resources and Energy (3) \n" +
                        "4. Rural and Urban Habitats (4) \n" +
                        "5. Industry, Transport and Physical Infrastructure (5) \n" +
                        "6. Tourism, Natural and Cultural Heritage (6)\n"},
                {"Plans", "For ensuring proper implementation of SDG 13 Policies and Strategies, Federal, Province and Local Level Government play various important roles: \n" +
                        "(1) At the federal level, responsibilities include formulating laws, standards, and a National Adaptation Plan, developing and implementing climate change programs, updating internationally national data, and participating in global climate forums and processes.\n" +
                        "(2) At the Provincial level, aligning policies, monitoring initiatives, and coordinating programs with federal and local levels takes place\n" +
                        "(3) Local authorities implement policies, conduct climate programs, monitor initiatives, raise awareness, and establish youth committees all in the local level for disaster management.\n"}
        };

        private static void displayTask(String task) {
            for (String[] taskData : TASKS_DATA) {
                if (taskData[0].equalsIgnoreCase(task)) {
        ...
        private static void Plans() {
            System.out.println(TASKS_DATA[2][1]);
        }

        public static void Strategies() {
            System.out.println(TASKS_DATA[1][1]);

            List<String> topics = new ArrayList<>();
            topics.add("Agriculture and Food Security (1) \n");
            topics.add("Forest, Biodiversity and Watershed Conservation (2) \n");
            topics.add("Water Resources and Energy (3) \n");
            topics.add("Rural and Urban Habitats (4) \n ");
            topics.add("Industry, Transport and Physical Infrastructure (5) \n");
            topics.add("Tourism, Natural and Cultural Heritage (6)\n");
            ...
            switch (f) {
                case 1:
                    System.out.println(TASKS_DATA[1][1] + "Agriculture based adaptation programs will be conducted by targeting poor, marginalized, landless, indigenous people and vulnerable households, women and persons with disability.\n" + "(b) Agricultural crops suitable for dry and waterlogged areas will be identified and Promoted.\n" + "(c) Technologies that");
                    ...
                    if (a == 1) {
                        ...
                        Scanner elaborated = new Scanner(System.in);
                        int g = elaborated.nextInt();
